...
<ul>
<li><b>Что делает:</b> собирает с роутера информацию, а-ля SYSLOG сервер. ~~Хранит~~ в текстовом логе.~~ Хранит в БД.</li>
...
<ul>
<li><b>Что делает:</b> отображает информацию из ~~текстового лога~~ БД. Позволяет залогиниться\разлогиниться. Добавить мак.</li>
